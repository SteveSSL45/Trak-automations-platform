# Stage 07: Strategy Synthesizer

> **Status:** placeholder. Operator fills this in with the trained LoRA's system prompt.

**Expected dossier inputs:** all upstream stages 1-6

**Expected outputs:** prioritized weekly plan reconciling all signals
...
5. Persist the response to `clients/<id>/swarm_runs/<date>/07_strategy_synthesizer.json`
