# Stage 02: Technical SEO Auditor

> **Status:** placeholder. Operator fills this in with the trained LoRA's system prompt.

**Expected dossier inputs:** crawl, pagespeed

**Expected outputs:** HTTP errors, indexability issues, Core Web Vitals
...
5. Persist the response to `clients/<id>/swarm_runs/<date>/02_technical_seo_auditor.json`
