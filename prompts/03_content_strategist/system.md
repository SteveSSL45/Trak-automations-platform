# Stage 03: Content Strategist

> **Status:** placeholder. Operator fills this in with the trained LoRA's system prompt.

**Expected dossier inputs:** gsc_weekly, ga4_daily

**Expected outputs:** topic gaps, underperforming pages, content briefs
...
5. Persist the response to `clients/<id>/swarm_runs/<date>/03_content_strategist.json`
