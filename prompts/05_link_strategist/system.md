# Stage 05: Link Strategist

> **Status:** placeholder. Operator fills this in with the trained LoRA's system prompt.

**Expected dossier inputs:** ahrefs, competitors

**Expected outputs:** backlink gaps, outreach targets, anchor diversification
...
5. Persist the response to `clients/<id>/swarm_runs/<date>/05_link_strategist.json`
