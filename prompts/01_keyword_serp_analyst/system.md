# Stage 01: Keyword + SERP Analyst

> **Status:** placeholder. Operator fills this in with the trained LoRA's system prompt.

**Expected dossier inputs:** gsc_daily, gsc_weekly

**Expected outputs:** queries, positions, striking-distance opportunities
...
5. Persist the response to `clients/<id>/swarm_runs/<date>/01_keyword_serp_analyst.json`
