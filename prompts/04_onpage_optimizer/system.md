# Stage 04: On-Page Optimizer

> **Status:** placeholder. Operator fills this in with the trained LoRA's system prompt.

**Expected dossier inputs:** crawl, gsc_daily

**Expected outputs:** title/meta drafts, header structure, internal links
...
5. Persist the response to `clients/<id>/swarm_runs/<date>/04_onpage_optimizer.json`
